...
\begin{itemize}
  \item the Event-Loop cancellation test cancels immediately after the \texttt{FSReportJob} is returned and checks that no terminal callback is emitted afterward;
...
The Event-Loop cancellation test avoids arbitrary sleeps and machine-speed assumptions, reducing timing sensitivity on local machines and CI runners.
