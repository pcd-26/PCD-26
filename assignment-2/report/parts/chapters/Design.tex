...
share the same argument parsing and report rendering logic, while the scan
...
Traversal is recursive: every subdirectory is scheduled as a separate task and
