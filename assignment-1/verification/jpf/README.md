...
- `target/jpf-classes` generated by the launcher or the integration test
...
`assignment-1/target/jpf-classes` before running the selected models. The
JUnit integration test performs the same compilation when the local JPF
