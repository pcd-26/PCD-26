...
\texttt{distributed-critical-sections} project directory, which contains
\texttt{pom.xml}. The demo entry point is implemented in
\texttt{src/main/java/pcd/dcs/demo/ProcessApp.java}.
...
mvn -f pom.xml exec:java "-Dexec.mainClass=pcd.dcs.demo.ProcessApp" "-Dexec.args=Process-A localhost 5672"
mvn -f pom.xml exec:java "-Dexec.mainClass=pcd.dcs.demo.ProcessApp" "-Dexec.args=Process-B localhost 5672"
\end{lstlisting}
