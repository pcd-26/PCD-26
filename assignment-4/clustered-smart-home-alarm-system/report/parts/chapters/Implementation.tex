...
{
\small
\begin{tabular}{|>{\raggedright\arraybackslash\bfseries}p{3.5cm}|>{\raggedright\arraybackslash}p{8.8cm}|}
    \hline
...
The adopted deployment rule is:
...
The \textbf{domain logic} remains close to assignment 3, while the clustered
changes are concentrated in the places where distribution matters:
\begin{itemize}
