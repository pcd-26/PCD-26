...
The implementation therefore needs a solution that guarantees \textbf{single
state ownership}, \textbf{remote discovery}, and \textbf{safe recovery} after
control-unit recreation.
