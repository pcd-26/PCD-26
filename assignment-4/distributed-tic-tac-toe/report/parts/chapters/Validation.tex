...
that requests are routed to the correct remote game instance, that independent
matches remain isolated, and that callback-driven updates expose consistent
\texttt{BoardState} snapshots to clients.
