...
The implementation favors a clear teaching-oriented design. It does not try
to introduce persistence or matchmaking policies beyond the assignment scope,
and it keeps the remote protocol intentionally small. In return, the code
stays easy to verify, the concurrency boundaries are obvious, and the project
remains faithful to the course goals.
