...
```bash
java -jar target/distributed-tic-tac-toe-1.0-SNAPSHOT-jar-with-dependencies.jar registry [port]
java -jar target/distributed-tic-tac-toe-1.0-SNAPSHOT-jar-with-dependencies.jar server [registryHost] [registryPort] [serviceName]
java -jar target/distributed-tic-tac-toe-1.0-SNAPSHOT-jar-with-dependencies.jar client [host] [port] [serviceName] [--cli]
```
...
From `assignment-4/distributed-tic-tac-toe`:
