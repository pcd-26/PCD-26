...
\texttt{DemoMain} starts the same actor graph with shorter delays and sends a fixed sequence of messages, useful for a
quick smoke test of the state machine.
...
This preserves the asynchronous message-passing style also for read-only operations.
